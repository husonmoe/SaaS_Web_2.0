...
export function UserManualHeroSection() {
  return (
    <section className="page-hero-section user-manual-hero-with-category-gap relative isolate overflow-visible pt-[60px] pb-8 lg:pt-[100px]">
      <PageHeroBgLayer />
      ...
      <PageContainer className="relative z-10 flex flex-col items-center gap-8 md:gap-10 lg:gap-10">
        <header className="flex max-w-[1200px] flex-col items-center gap-4 text-center">
          ...
          <p className="text-lg leading-[26px] text-[var(--text-secondary)] md:text-xl md:leading-normal lg:max-w-[888px] lg:text-2xl lg:leading-8">
