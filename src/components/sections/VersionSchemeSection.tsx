      ...
      <PageContainer className="flex flex-col items-center gap-8 md:gap-16">
        ...
        <FadeInOnScroll as="div">
          <Link
            ...
            className={cn(
              "flex h-14 min-h-14 w-[200px] items-center justify-center gap-0.5 rounded-full border border-[var(--border-light)] bg-white pl-5 pr-3 text-base text-[var(--text-base)] transition-colors hover:bg-[var(--btn-outline-hover)] active:bg-[var(--btn-outline-active)] md:h-[60px] md:min-h-[60px] md:w-auto md:pl-10 md:pr-8 md:text-lg",
            )}
          >
            <span>查看版本对比</span>
            <Image
