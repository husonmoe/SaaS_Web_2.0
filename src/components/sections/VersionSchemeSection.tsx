      ...
      <PageContainer className="flex flex-col items-center gap-8 md:gap-16">
        ...
        <FadeInOnScroll as="div">
          <Link
            ...
            className={cn(
              "inline-flex h-12 min-h-12 items-center justify-center gap-1 rounded-full border border-[var(--border-light)] bg-white px-8 text-base text-[var(--text-secondary)] transition-colors hover:bg-[var(--btn-outline-hover)] active:bg-[var(--btn-outline-active)] md:h-[60px] md:min-h-[60px] md:pl-10 md:pr-8 md:text-lg",
            )}
          >
            <span>查看版本对比</span>
            <Image
