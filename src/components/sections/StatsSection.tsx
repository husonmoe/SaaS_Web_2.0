  ...
  return (
    <section className="bg-white py-16 md:py-[100px]">
      <PageContainer className="flex flex-col items-center gap-16">
        <FadeInOnScroll as="div" className="flex w-full max-w-[1200px] flex-col items-center gap-16">
          <div className="text-center">
            <h2 className="text-3xl font-semibold leading-tight text-[var(--text-base)] md:text-[44px] md:leading-[56px]">
              资源覆盖百万基层
            </h2>
            <p className="mt-3 text-lg text-[var(--text-secondary)] md:text-xl md:leading-7">
